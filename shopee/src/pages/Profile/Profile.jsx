      ...
      <S.PurchaseWrapper>
        <S.PurchaseProfile>
          ...
          <S.PurchaseProfileBar>
            ...
            <S.PurchaseProfileBarItem to={path.purchase}>
              <img
        ...
        <S.ProfileContent>
          ...
          <S.ProfileContentSection>
            <table>
              <tr>
                <td className="title">Tên đăng nhập</td>
                <td className="infor">{profile.username || profile.email}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="infor">{profile.email}</td>
              </tr>
              <tr>
                <td className="title">Điện thoại</td>
                <td className="infor">
                  <input type="" value={profile.phone} />
                </td>
              </tr>
              <tr>
