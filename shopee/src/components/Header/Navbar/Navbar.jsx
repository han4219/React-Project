...
export default function Navbar() {
  const dataUser = useSelector(state => state.auth.profile)
  ...
  return (
    <Wrapper>
      <NavLeft>
        <LinkLeft href="">kênh người bán</LinkLeft>
        <LinkLeft href="">trở thành người bán shopee</LinkLeft>
        <LinkLeft href="">tải ứng dụng</LinkLeft>
        <SocialContainer>
          kết nối
          <LinkFacebook href="">
      ...
      <NavRight>
        <Notification href="" className="noti">
          <Icon className="far fa-bell"></Icon>thông báo
        </Notification>
        <Support href="" className="support">
          <Icon className="far fa-question-circle"></Icon>hỗ trợ
        </Support>
        <Language>
          <Icon className="fas fa-language"></Icon>
          <SelectLanguage name="language">
            <OptionLanguage value="Tiếng Việt">Tiếng Việt</OptionLanguage>
            <OptionLanguage value="English">English</OptionLanguage>
          </SelectLanguage>
        </Language>
        {authenticated && (
          <User onMouseOver={showPopOver} onMouseLeave={hidePopOver}>
            ...
            <UserNameWrapper className="user-name">
              <UserName>{dataUser.name || dataUser.email}</UserName>
            </UserNameWrapper>
        ...
        {!authenticated && (
          <div className="sign">
            <LoginLink to={path.login}>đăng nhập</LoginLink>
            <RegisterLink to={path.register}>đăng ký</RegisterLink>
          </div>
        )}
      </NavRight>
    </Wrapper>
